...
bot.on("message", async (msg) => {
    ...
    try {
        if (text === "/start") {
            ...
            return await bot.sendSticker(chatId, "CAACAgIAAxkBAAEKmT9lON1ybAJkZkNfYInsQ7QMhs19rwAC0Q8AAqeAyEtx1lPcgJ-pWTAE");
        }
        if (text === "/info") {
        ...
        bot.sendMessage(chatId, "An error occured. Please refer to our technical support. @iz8jnek");
        console.error(error);
    }
});
bot.on("callback_query", async (msg) => {
    ...
    if (chatId) {
        ...
        if (data === chats[chatId]) {
            ...
            return await bot.sendMessage(chatId, `Unfortunately, you didn't guess the number. It was ${chats[chatId]}. Try again!`, againOptions);
        }
    }
});
